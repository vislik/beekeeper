...
<template>
  <section ref="heroRef" class="hero">
    ...
    <div class="container hero-content">
      <p class="hero-kicker">Медовый путь</p>
      <h1>Натуральное пчеловодство без компромиссов по чистоте продукта</h1>
      <p>
        Работаем с уважением к природным циклам: без антибиотиков, бипина, амитраза и сахарных
        подкормок. В фокусе — здоровье пчелиной семьи и честный натуральный мёд.
      </p>
